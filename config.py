...
CASSANDRA_KEYSPACE2 = os.getenv('CASSANDRA_KEYSPACE2','stats')
CASSANDRA_PRICES_KEYSPACE = os.getenv('CASSANDRA_PRICES_KEYSPACE','prices')
CASSANDRA_STATS_KEYSPACE = os.getenv('CASSANDRA_STATS_KEYSPACE','stats')
CASSANDRA_PORT = os.getenv('CASSANDRA_PORT','9042')
CASSANDRA_USER = os.getenv('CASSANDRA_USER','')
CASSANDRA_PASSWORD = os.getenv('CASSANDRA_PASSWORD','')
CASSANDRA_SEEDS = os.getenv('CASSANDRA_SEEDS','0.0.0.0')

SPARK_HOME = os.getenv('SPARK_HOME','/opt/spark')
SPARK_MASTER_IP = os.getenv('SPARK_MASTER_IP','spark://10.0.0.78:7077')
